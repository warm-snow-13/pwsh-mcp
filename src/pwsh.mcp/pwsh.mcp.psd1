#
# Module manifest for module 'pwsh.mcp'
#
...
FunctionsToExport = 'Add-MCPServer', 'New-MCPServer'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'AI','MCP','MCP Server','PowerShell','Module'
        ...
        IconUri = 'https://github.com/warm-snow-13/pwsh-mcp/blob/main/docs/assets/micon.png'
